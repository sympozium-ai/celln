...
for test in signed_closure_on_real_kvm declared_parent_launcher_on_real_kvm declared_substrate_on_real_kvm dispatch_outcomes_on_real_kvm json_harness_grant_issuance_on_real_kvm json_direct_adapter_on_real_kvm scoped_mediated_lifecycles_on_real_kvm scoped_brokered_artifacts_three_turns_on_real_kvm; do
  code=0
